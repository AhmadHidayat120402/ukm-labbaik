...
<head>
    ...
    <title>UKM -LABBAIK | Politeknik Negeri Jember</title>
        ...
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="https://getbootstrap.com/docs/5.3/assets/brand/bootstrap-logo.svg" alt="Bootstrap"
                    width="30" height="24"> UKM - LABBAIK
            </a>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown mx-3">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#">Syiar</a></li>
                            <li><a class="dropdown-item" href="#">PSDM</a></li>
                            <li><a class="dropdown-item" href="#">KWU</a></li>
                            <li><a class="dropdown-item" href="#">Kemuslihan</a></li>
                        </ul>
                    </li>
