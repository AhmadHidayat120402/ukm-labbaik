...
<head>
  ...
  <title>Web Travel Landing Page</title>
...
<body>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">
            <img src="images/image/ProbVel..svg" alt="logo">
          </a>
            ...
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="#">Bromo Packages</a></li>
                  <li><a class="dropdown-item" href="#">Yogyakarta Packages</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="#">Bromo Mountain</a></li>
                  <li><a class="dropdown-item" href="#">Borobudur Temple</a></li>
                  <li><a class="dropdown-item" href="#">Religi Destinations</a></li>
                </ul>
              </li>
            </ul>
            <a href="#" class="btn btn-outline-light rounded-0 px-3 py-2">Register</a>
          </div>
        </div>
      </nav>
      <div class="content">
        <h1 class="header-title text-white text-capitalize fw-bold">explore the world <br> easily and safely</h1>
        <p class="header-description text-white text fw-light">Lorem, ipsum dolor sit amet consectetur adipisicing elit.
          ...
          Dolores rerum corrupti alias consectetur eligendi.
        </p>
      </div>
    </div>
  </header>
  ...
  <section class="why-choose">
    <div class="container">
      ...
      flex-md-row align-item-center justify-content-between gap-3">
        <h2 class="section-title w-75">Why Choose us?</h2>
            ...
            <div class="card-body p-3">
              <div class="d-flex flex-row align-items-center gap-3">
                <div class="icons rounded-circle ">
                  <img src="images/image/world.svg" alt="world" height="30px">
                </div>
                <h4 class="card-title fw-bold m-0">Private Guid</h4>
              </div>
        ...
        <div class="col-md-4 border-0">
          <div class="card mt-3 boxs">
            <div class="card-body p-3">
              <div class="d-flex flex-row align-items-center gap-3">
                <div class="icons rounded-circle ">
                  <img src="images/image/flash-sale 1.svg" alt="world" height="30px">
                </div>
                <h4 class="card-title fw-bold m-0">Affordable Price</h4>
              </div>
              <div class="section-description mt-3">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa porro modi tempore debitis maxime quos.
              </div>
        ...
        <div class="col-md-4 border-0">
          <div class="card mt-3 boxs">
            <div class="card-body p-3">
              <div class="d-flex flex-row align-items-center gap-3">
                <div class="icons rounded-circle ">
                  <img src="images/image/holidays 1.svg" alt="world" height="30px">
                </div>
                <h4 class="card-title fw-bold m-0">Great Support</h4>
              </div>
              <div class="section-description mt-3">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa porro modi tempore debitis maxime quos.
              </div>
  ...
  <section class="popular-destionation">
    <div class="container">
      <div class="d-flex flex-column flex-sm-column
    flex-md-row align-item-center justify-content-between gap-3 ">
        <h2 class="section-title w-50">Popular Destinations</h2>
        <a href="#" class="btn btn-primary rounded-0 mt-2 fw-bold">Explore More</a>
      </div>
      <div class="row mt-5">
        <div class="col-md-3 mt-3">
          <a href="#" class="card border-0 boxs">
            <img src="images/image/gunung-bromo.png" alt="gunung bromo" class="images">
            <div class="card-body">
              <h4 class="card-title fw-bold">Gunung Bromo</h4>
              <p class="d-flex align-items-center gap-2">
                <i class="bx bxs-map"></i>
                Probolinggo,Jawa Timur
              </p>
              <hr>
              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. At, eos!</p>
            </div>
        ...
        <div class="col-md-3 mt-3">
          <a href="#" class="card boxs border-0 ">
            <img src="images/image/madakaripura.png" alt="Madakaripura" class="images">
            <div class="card-body">
              <h4 class="card-title fw-bold">Madakaripura</h4>
              <p class="d-flex align-items-center gap-2">
                <i class="bx bxs-map"></i>
                Probolinggo,Jawa Timur
              </p>
        ...
        <div class="col-md-3 mt-3">
          <a href="#" class="card boxs border-0">
            <img src="images/image/gili-ketapang.png" alt="Gili Ketapang" class="images">
            <div class="card-body">
              <h4 class="card-title fw-bold">Gili ketapang</h4>
              <p class="d-flex align-items-center gap-2">
                <i class="bx bxs-map"></i>
                Probolinggo,Jawa Timur
              </p>
        ...
        <div class="col-md-3 mt-3">
          <a href="#" class="card boxs border-0">
            <img src="images/image/bremi-park.png" alt="Bremi Park" class="images">
            <div class="card-body">
              <h4 class="card-title fw-bold">Bremi Park</h4>
              <p class="d-flex align-items-center gap-2">
                <i class="bx bxs-map"></i>
                Probolinggo,Jawa Timur
              </p>
  ...
  <section class="take-break">
    <div class="container ">
      <div class="row align-items-center">
        <div class="col-md-6">
          <img src="images/image/take-break.png" alt="take-break" class="image" width="600px">
        </div>
        <div class="col-md-6 align-items-center mt-5">
          <h2 class="section-title">Take a Break & Checkout
            Our Top Destinations</h2>
          <p class="section-description mb-4">We pride ourselves on providing the best in service and we will never
            take
            it
            for granted. Our team is ready to be your partner to make your holiday feel better and more wonderful. </p>
          <div class="d-flex align-items-center gap-5">
            <a href="#" class="btn btn-primary align-items-center">Learn More</a>
            <a href="#" class="d-flex align-items-center gap-3">
              <img src="images/image/Ellipse 27.png" alt="take-break" class="image">
              Watch Video
            </a>
          </div>
        </div>
  ...
  <section class="travel-Packages">
    <div class="container">
      <h2 class="section-title text-center">Our Travel Packages</h2>
      ...
      <div class="row mt-5">
        <div class="col-md-4 mt-3">
          <a href="#" class="card text-center">
            <img src="images/image/indonesia-tour.png" alt="indonesian tour" class="card-image">
            <div class="card-body boxs">
              <h4 class="card-title mt-3">Indonesia Tour Packages</h4>
              <p class="section-description px-2">Lorem ipsum dolor sit amet consectetur adipisicing.</p>
              <hr class="mx-auto w-75">
              <p class="price">Rp 10.500.000/ <span class="section-description">People</span></p>
            </div>
            <div class="flag bg-white p-2 rounded-circle shadow-sm position-absolute">
              <img src="images/image/indonesia.png" alt="">
            </div>
          </a>
        </div>
        <div class="col-md-4 mt-3">
          <a href="#" class="card text-center">
            <img src="images/image/singapore-tour.png" alt="indonesian tour" class="card-image">
            <div class="card-body boxs">
              <h4 class="card-title mt-3">Singapore Tour Packages</h4>
              <p class="section-description px-2">Lorem ipsum dolor sit amet consectetur adipisicing.</p>
              <hr class="mx-auto w-75">
              <p class="price">Rp 15.500.000/ <span class="section-description">People</span></p>
            </div>
            <div class="flag bg-white p-2 rounded-circle shadow-sm position-absolute">
              <img src="images/image/singapore.png" alt="">
            </div>
          </a>
        </div>
        <div class="col-md-4 mt-3">
          <a href="#" class="card text-center">
            <img src="images/image/thailand-tour.png" alt="indonesian tour" class="card-image">
            <div class="card-body boxs">
              <h4 class="card-title mt-3">Thailand Tour Packages</h4>
              <p class="section-description px-2">Lorem ipsum dolor sit amet consectetur adipisicing.</p>
              <hr class="mx-auto w-75">
              <p class="price">Rp 17.500.000/ <span class="section-description">People</span></p>
            </div>
            <div class="flag bg-white p-2 rounded-circle shadow-sm position-absolute">
              <img src="images/image/thailand.png" alt="">
            </div>
          </a>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row ">
        <div class="col-md-6 position-relative">
          ...
          <form action="get" class="inputan bg-white p-5 w-75 mx-auto d-block" style="transform: translateY(-100px);">
          ...
          <div class="icon-fire position-absolute p-3 rounded-circle bg-white shadow-sm">
            <img src="images/image/flash-sale 1.svg" alt="">
          </div>
        </div>
        <div class="col-md-6 align-items-center mt-5" style="transform: translateX(50px);">
